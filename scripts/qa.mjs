...
const EXPECT = {
  "/": [
    ...
    "für Anrufe, Website, CRM, Docs & Portal",
  ...
  "/plattform": [
    ...
    "Kein Anruf",
    "geht verloren.",
    "automatisch beim richtigen Lead im CRM",
    "Gebaut, nicht",
    "zusammengeklickt.",
  ...
  "/ueber": [
    ...
    "Lunakris baut KI-Systeme, die Arbeit wirklich abnehmen",
    "Echt statt Schein",
